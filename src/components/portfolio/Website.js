        ...
        return (
            <article className={"portfolio-article p-5 " + classes}>
                <picture>
                    ...
                    <img src="../images/DevFecta.png" className="col-md-3 float-end m-3 img-fluid" width="auto" height="auto" alt={this.props.title} loading="lazy" style={{"boxShadow": "2px 2px 5px rgba(0, 0, 0, 0.5)"}} />
                </picture>
